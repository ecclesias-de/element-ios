...
enum AuthenticationEmailServerSelectionViewModelResult {
...
struct AuthenticationEmailServerSelectionViewState: BindableState {
    /// View state that can be bound to from SwiftUI.
    var bindings: AuthenticationEmailServerSelectionBindings
    ...
    var hasValidationError: Bool {
        bindings.email.isEmpty || isShowingFooterError
    }
}

struct AuthenticationEmailServerSelectionBindings {
    /// The homeserver address input by the user.
    var email: String = ""
    /// Information describing the currently displayed alert.
    var alertInfo: AlertInfo<AuthenticationEmailServerSelectionErrorType>?
}

enum AuthenticationEmailServerSelectionViewAction {
...
enum AuthenticationEmailServerSelectionErrorType: Hashable {
    /// An error message to be shown in the text field footer.
